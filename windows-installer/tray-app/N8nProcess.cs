    ...
    internal class N8nProcess
    {
        ...
        public void Start()
        {
            lock (_lock)
            {
                ...
                // Give the n8n runtime an 8GB old-space heap. Default is borderline
                // for n8n's process — running multiple workflows can push it over —
                // and matches the install-time ceiling in Invoke-Npm.
