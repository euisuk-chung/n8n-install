...
namespace N8nTray
{
    ...
    internal static class Localization
    {
        ...
        private static readonly Dictionary<string, string> En = new Dictionary<string, string>
        {
            ...
            { "Status.Installing",  "Downloading n8n… (typically 5–15 min, longer on slow links)" },
